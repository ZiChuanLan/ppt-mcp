...
def ppt_list_routes() -> dict[str, Any]:
    """List the simplified high-level routes such as mineru or layout_block."""
    try:
...
@mcp.tool()
def ppt_check_route(route: str) -> dict[str, Any]:
    """Check whether a simplified route is ready and show its effective config."""
    try:
...
def ppt_convert_pdf(
    pdf_path: str,
    route: str = "layout_block",
    page_start: int | None = None,
    page_end: int | None = None,
    retain_process_artifacts: bool = False,
    extra_options: dict[str, Any] | None = None,
) -> dict[str, Any]:
    """Create a conversion job using a simple route like mineru or layout_block.
